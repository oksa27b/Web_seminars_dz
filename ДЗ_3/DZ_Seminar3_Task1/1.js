...
const temperCelsius = prompt("Введите корректную температуру в градусах цельсия");
const temperFahrenheit = (9 / 5) * temperCelsius + 32;
alert(`Цельсий: ${temperCelsius}, Фаренгейт: ${temperFahrenheit.toFixed(0)}`);
